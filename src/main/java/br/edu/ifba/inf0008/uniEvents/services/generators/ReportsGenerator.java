...
public class ReportsGenerator {
  public static String generateReport(List<Event> events, String reportTitle, Boolean isDetailed) {
    ...
    report.append(Lines.centeredMultiLineText(String.format("Report: %s", reportTitle))).append("\n");
    report.append(Lines.centeredMultiLineText(String.format("Created at: %s", LocalDateTime.now().format(LocalDateAdapter.DATE_TIME_FORMATTER)))).append("\n");
